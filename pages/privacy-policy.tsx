    ...
    <Layout navbar={{}}>
      ...
      <div className="col-span-full">
        <div className="mt-4 mb-4 w-full px-4 md:px-16">
          ...
          <Paragraph>
            At SHOWROOM, accessible from https://showroom.art, one of our main
            priorities is the privacy of our visitors. This Privacy Policy
            document contains types of information that is collected and
            recorded by SHOWROOM and how we use it.
            <br />
            <br />
          ...
          <H2>Log Files</H2>
          <Paragraph>
            SHOWROOM follows a standard procedure of using log files. These
          ...
          <Paragraph>
            Like any other website, SHOWROOM uses &apos;cookies&apos;. These
          ...
          <Paragraph>
            ...
            based upon their visit to showroom.art and other sites on the
          ...
          <Paragraph>
            ...
            advertising partners of SHOWROOM.
            <br />
            <br />
            Third-party ad servers or ad networks uses technologies like
            cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on SHOWROOM, which
            ...
            <br />
            <br />
            Note that SHOWROOM has no access to or control over these cookies
            that are used by third-party advertisers.
          </Paragraph>
          <H2>Third Party Privacy Policies</H2>
          <Paragraph>
            SHOWROOM&apos;s Privacy Policy does not apply to other advertisers
          ...
          <Paragraph>
            ...
            <br />
            <br />
            SHOWROOM does not knowingly collect any Personal Identifiable
          ...
          <Paragraph>
            ...
            that they shared and/or collect in SHOWROOM. This policy is not
