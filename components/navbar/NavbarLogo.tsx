...
const NavbarLogo: FC<Props> = ({ variant, className }) => {
  ...
  return (
    <div className="flex flex-col sm:flex-row justify-center items-center">
      ...
      <div className="text-xs items-center inline-flex font-bold leading-sm uppercase px-3 py-1 bg-lime-200 text-lime-700 rounded-full" style={{ marginTop: '-56px', marginLeft: '-24px', marginRight: '20px' }}>Beta</div>
    </div>
  )
}
